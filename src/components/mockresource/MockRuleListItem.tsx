...
import { MockCondition } from "../../models/MockCondition";
      ...
      <div>
        ...
        <div className="row mt-3">
          <div className="col-md-12">
            ...
            <ul>
              { (this.props.item.response.parameters?.length === 0 || this.props.item.response.parameters === undefined) && <li>No parameter to be injected.</li> }
              {
                this.props.item.response.parameters?.length > 0 &&
                this.props.item.response.parameters?.map((parameter, key: any) => {
                  return (
