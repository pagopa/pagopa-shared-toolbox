...
type Props = {
  ...
  operation: string,
  setMockResouce: (resource: MockResource) => void,
  mockResource?: MockResource
};


export const MockResourceHandlingForm = ({redirectToPreviousPage, onSubmitShowModal, operation, setMockResouce, mockResource}: Props) => {
  ...
  return (
    <Paper elevation={8} sx={{ marginBottom: 2, borderRadius: 4, p: 4 }}>
      ...
      
      {
        operation === "CREATE" &&
        <>
          <Grid container alignItems={"center"} spacing={0} mt={3} mb={2}>
            <Grid item xs={11}>
          ...
          <Grid container alignItems={"center"} spacing={0} mb={2} xs={10}>
